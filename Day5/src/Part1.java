...
public class Part1 {
    public static void main(String[] args) throws IOException {
        ...
        Part1.stackFiller(s1, a1);
        Part1.stackFiller(s2, a2);
        Part1.stackFiller(s3, a3);
        Part1.stackFiller(s4, a4);
        Part1.stackFiller(s5, a5);
        Part1.stackFiller(s6, a6);
        Part1.stackFiller(s7, a7);
        Part1.stackFiller(s8, a8);
        Part1.stackFiller(s9, a9);
        ...
        while((currentLine = reader.readLine()) != null){
            ...
            if(currentLine.charAt(6) != ' '){
                ...
                Part1.stackMover(crates[from - 1], crates[to - 1], howMany);
            }
            else{
